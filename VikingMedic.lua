-----------------------------------------------------------------------------------------------
-- Client Lua Script for VikingMedic
...
function VikingMedic:Init()
    Apollo.RegisterAddon(self, nil, nil, {"ActionBarFrame"})
end

function VikingMedic:OnLoad()
	--[[ DEPRECATED: Replaced by \ClassResources\
	self.xmlDoc = XmlDoc.CreateFromFile("VikingMedic.xml")
...
function VikingMedic:OnDocumentReady()
	self.bDocLoaded = true
	self:OnRequiredFlagsChanged()
end

function VikingMedic:OnRequiredFlagsChanged()
...
function VikingMedic:OnCharacterCreated()
	local unitPlayer = GameLib.GetPlayerUnit()

	if not unitPlayer then
		return
	elseif unitPlayer:GetClassId() ~= GameLib.CodeEnumClass.VikingMedic then
...
function VikingMedic:OnFrame()
	...
	local strMana = String_GetWeaselString(Apollo.GetString("VikingMedic_FocusTooltip"), nManaCurrent, nManaMax)
...
function VikingMedic:DrawCores(unitPlayer)
...
-----------------------------------------------------------------------------------------------
-- VikingMedic Instance
-----------------------------------------------------------------------------------------------
local VikingMedicInst = VikingMedic:new()
VikingMedicInst:Init()
